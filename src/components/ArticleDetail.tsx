...
function ArticleDetail({ article, onBack }: Props) {
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: () => {
            // Refresh the list so the deleted item disappears, then navigate back
    ...
    const getCategoryGradient = (cat: string) => {
        ...
        // Fallback to a neutral grey if category doesn't match
            ...
            >
                <div className="detail-actions">
                    ...
                    <div style={{ display: 'flex', gap: '10px' }}>
                        ...
                        <button
                            onClick={() => {
                                // Simple confirm check before hitting the API
...
function arePropsEqual(prev: Props, next: Props) {
    return (
        ...
        // We're assuming the parent passes a stable onBack reference here
